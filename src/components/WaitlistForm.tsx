...
const WaitlistForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // To get this URL: Create a Google Form → Get pre-filled link → Extract the base URL and entry IDs
      const formUrl = "https://docs.google.com/forms/d/e/YOUR_FORM_ID/formResponse";
      
      const formBody = new FormData();
      formBody.append("entry.123456789", formData.name); // Replace with actual entry ID from Google Form
      formBody.append("entry.987654321", formData.email); // Replace with actual entry ID
      formBody.append("entry.456789123", formData.socialHandle); // Replace with actual entry ID
      formBody.append("entry.112233445", formData.primaryPlatform); // Replace with actual entry ID
  ...
  if (isSubmitted) {
    return (
      <section id="waitlist" className="py-20 bg-gradient-to-br from-brandmate-purple via-indigo-600 to-purple-700 relative overflow-hidden">
            ...
            <CardContent className="p-10 text-center space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="font-inter text-lg text-brandmate-muted leading-relaxed">
                  You're officially on the BrandMate waitlist. Get ready for early access to the most powerful creator toolkit ever built.
                </p>
                <div className="flex items-center justify-center gap-2 text-brandmate-gold">
                  <Star className="w-5 h-5 fill-current" />
                  <span className="font-inter font-semibold">Priority Access Secured</span>
                  <Star className="w-5 h-5 fill-current" />
                </div>
              </div>
  ...
  return (
    <section id="waitlist" className="py-24 bg-gradient-to-br from-brandmate-purple via-indigo-600 to-purple-700 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center px-6 py-3 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 shadow-xl mb-8">
            ...
            <span className="text-base font-inter font-semibold text-white">🎯 Limited Early Access • Join 1000+ Creators</span>
          </div>
          ...
          <p className="font-inter text-xl text-white/90 leading-relaxed max-w-2xl mx-auto">
            Join the waitlist for the ultimate all-in-one creator toolkit. From viral content to brand deals – we've got you covered.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-5">
                <div className="space-y-3">
                  <Label htmlFor="name" className="font-inter font-semibold text-brandmate-slate text-base">
                    Full Name
                  </Label>
                  <Input
                    id="name"
                ...
                <div className="space-y-3">
                  <Label htmlFor="email" className="font-inter font-semibold text-brandmate-slate text-base">
                    Email Address
                  </Label>
                  <Input
                    id="email"
                ...
                <div className="space-y-3">
                  <Label htmlFor="platform" className="font-inter font-semibold text-brandmate-slate text-base">
                    Primary Platform
                  </Label>
                  <Select value={formData.primaryPlatform} onValueChange={(value) => handleInputChange("primaryPlatform", value)}>
                ...
                <div className="space-y-3">
                  <Label htmlFor="social" className="font-inter font-semibold text-brandmate-slate text-base">
                    Social Handle
                  </Label>
                  <Input
                    id="social"
              ...
              <p className="text-center text-sm text-brandmate-muted font-inter leading-relaxed">
                By joining, you agree to receive updates about BrandMate.<br />
                <span className="font-semibold">Unsubscribe anytime.</span> We respect your privacy.
              </p>
            </form>
          </CardContent>
        </Card>
        ...
        <div className="text-center mt-12 animate-fade-in">
          <p className="font-inter text-white/80 text-lg">
            🔥 <span className="font-semibold">500+ creators</span> already secured their spot
          </p>
        </div>
      </div>
    </section>
